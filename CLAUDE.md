...
>
> This is the **production** instance of God-Agent.
> - Production data in `./data`
> - MCP instance: `mcp__rubix__*` points to THIS production build
> - `god-agent-dev` is a separate local dev copy (gitignored) for testing changes before production
  ...
  "mcpServers": {
    "rubix-core-brain": {
      ...
      "env": {
        ...
        "RUBIX_PROJECT_ROOT": "D:\\rubix-protocol",
